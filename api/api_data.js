define({ api: [
        ...
        "Response": [
          {
            ...
            "field": "tradeDeal",
            "optional": false,
            "description": "<p>tradeDeal JSON structure</br>Note : <code>tradeDealSubtype</code> can have following values:</br><code>MarketTaker</code></br><code>MarketMaker</code></br></p>"
          }
        ]
      },
      "examples": [
        ...
        "Response": [
          {
            ...
            "field": "array",
            "optional": false,
            "description": "<p>array of tradeDeals</br>Note : <code>tradeDealSubtype</code> can have following values:</br><code>MarketTaker</code></br><code>MarketMaker</code></br></p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "group": "Public_Charts",
    "version": "1.0.0",
    "description": "<p>Retrieves the orderbook for a public market for the given currency pair as defined by <a href=\"http://bitcoincharts.com/about/exchanges/\">http://bitcoincharts.com/about/exchanges/</a>This API has been implemented according to the &quot;Orderbook&quot; specification of bitcoincharts.com, see <a href=\"http://bitcoincharts.com/about/exchanges/\">http://bitcoincharts.com/about/exchanges/</a>, but can be used for other applications as well.</p>",
    "permission": "public",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  },
  {
    ...
    "group": "Public_Charts",
    "version": "1.0.0",
    "description": "<p>Retrieves the trades for a public market for the given currency pair.This API has been implemented according to the &quot;Trade history&quot; specification of bitcoincharts.com, see <a href=\"http://bitcoincharts.com/about/exchanges/\">http://bitcoincharts.com/about/exchanges/</a>, but can be used for other applications as well.The number of items in the response array is limited to 1000 per call.In order to fetch all trades to date, start calling the API beginning with &quot;since=0&quot; and change &quot;since&quot; to the last received &quot;tid&quot; until less than 1000 entries are returned.</p>",
    "permission": "public",
    "parameter": {
      "fields": {
        "Parameter": [
